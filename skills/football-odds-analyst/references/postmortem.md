...
## KB-20: 跨赛事回测验证框架（从 knowledge-base.md 移入）
...
### 20.4 独立复盘（从 betting-sop.md 5.2 移入）
...
## O-11: STANDARD 仓位 179 场回测无效
- **来源**: 2026-06-23 三赛事179场回测
- **现象**: OCI 50-65%信心分区间 = STANDARD档，实际仅51%(33/65)。2024欧洲杯跌至38%(9/24)
- **处理**: v3.5.2 正式废除 STANDARD 档

## O-12: OCI1_RISE + OCI4_NEUTRAL 持续低于随机
- **来源**: 2026-06-23 179场回测
- **现象**: OCI1_RISE 46.9%(n=64), OCI4_NEUTRAL 42.9%(n=49)，均为系统性反向指标
- **处理**: v3.5.2 归一化权重，两个信号为负值(-0.06和-0.14)

## O-13: OCI2_AGREE 信息量有限
- **来源**: 2026-06-23 179场回测
- **现象**: 市场共识命中率仅54.8%(n=177)，样本最大但增量信息甚微
- **处理**: v3.5.2 权重降至+0.10

## O-14: 冷门翻转偏离门槛从2→3
- **来源**: 2026-06-23 179场回测
- **现象**: 偏离≥2触发翻转，回测命中率53.8%(7/13)
- **处理**: v3.5.2 提高到偏离≥3触发
