...
### 13.5b M串N Risk Distribution Rules

> 防守/进攻比例由四步决策树决定（替代固定比例）:
...
赔率阈值依据:
  2串1≥1.80: 覆盖竞彩返奖率(0.89)²≈1.26 + 滑点3%×2≈0.913 + 容错回本底线
  3串1≥4.50: 覆盖联合概率衰减(0.60³=21.6%) + 滑点累积 + 进攻仓风险补偿
  不达标不投: 避免大数定律温水煮青蛙 / 保护机会成本 / 维持系统纯洁性
