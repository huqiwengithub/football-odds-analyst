...
description: "Scrape full football odds data from 500.com. v2.6: shuju页结构化赛前信息提取."
agent_created: true
version: "2.6"
---

# 500.com Football Odds Scraper v2.6

> **v2.6 shuju页结构化赛前信息提取**: 新增 formation/key_absences/form_trend/avg_goals 等 pre_match_info 字段。
